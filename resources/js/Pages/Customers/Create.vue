...
const form = reactive({
  name: null, kana: null, company: null, tel: null, email: null, postcode: null,
  address: null,  memo: null
})
                        ...
                        <div class="container px-5 py-7 mx-auto">
                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="flex flex-wrap -m-2">
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  <label for="company" class="leading-7 text-sm text-gray-600">企業名</label>
