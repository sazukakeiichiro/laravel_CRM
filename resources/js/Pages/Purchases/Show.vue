...
onMounted(() => { 
 ...
 console.log(props.order[o].customer_name)
}) 
                        ...
                        <div class="container px-5 py-7 mx-auto">
                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="flex flex-wrap -m-2">
                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                  <thead>
                                    <tr>
                                      ...
                                      <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">人数</th>
                                      <th class="w-10 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tr rounded-br">小計</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                              ...
                              <div class="p-2 w-full">
                                <div class="">
                                  <label for="" class="leading-7 text-sm text-gray-600">担当者</label><br>
                                  <div class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
